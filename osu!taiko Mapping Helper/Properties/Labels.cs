namespace osu_taiko_Mapping_Helper.Properties
{
    internal class Labels
    {
        internal static readonly Dictionary<string, string> LabelsJp = new()
        {
            ...
            { "LBL_OBJECTS_SPECIFIC_HITOBJECTS", "特定のObjectのみ" },
            ...
            { "LBL_SETTINGS_HEXA_AND_DUO_OFFSET", "1/16(1/12)オフセット" },
            { "LBL_SETTINGS_MILLISECOND", "ミリ秒(ms)オフセット" },
        ...
        internal static readonly Dictionary<string, string> LabelsEn = new()
        {
            ...
            { "LBL_SETTINGS_HEXA_AND_DUO_OFFSET", "1/16 (1/12) offset" },
            { "LBL_SETTINGS_MILLISECOND", "ms offset" },
